...
public class PlayerPerformanceRanking {
    TeamRepository teamRepository;
        ...
        public void DisplayPlayerPerformance() {
            ...
            Collections.sort(players, new Comparator<PlayerPerformance>() {
                @Override
                public int compare(PlayerPerformance p1, PlayerPerformance p2) {
                    // Sort in descending order
                    return Double.compare(p2.calculatePerformanceScore(), p1.calculatePerformanceScore());
                }
            });
            ...
            frame.setSize(600, 400); // Adjusted size for better display
            ...
            gbcContent.fill = GridBagConstraints.NONE; // Do not stretch to fill the space
            gbcContent.weightx = 0;
